...
export function CreateGoalModal({
  ...
  useEffect(() => {
    if (fetchedGoalData && mode === "edit") {
      const startDate = new Date(fetchedGoalData.start_date);
      const endDate = new Date(fetchedGoalData.end_date);
      ...
      setValue("startDate", formatDateTimeLocal(startDate));
      setValue("endDate", formatDateTimeLocal(endDate));
    }
