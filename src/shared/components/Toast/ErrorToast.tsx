...
/**
 * Error toast component with Tailwind CSS styling
 * Auto-closes after 5 seconds with a close button
 */
export const ErrorToast: React.FC<{ message: string; toastId?: string }> = ({
  message,
  toastId,
}) => {
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-secondary text-white rounded-md shadow-md w-full max-w-md">
